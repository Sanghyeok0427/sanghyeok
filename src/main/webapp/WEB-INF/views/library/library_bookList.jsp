					...
					<c:forEach var="bdto" items="${booklist}">
						<tr>
							<c:if test="${bdto.image == 'none'}">
								<td>
									<a href="library_bookView.do?book_id=${bdto.book_id}&genre=${bdto.genre}"><img src="resources/book_img/no_image.png" class="book-img-thumbnail"></a>
								</td>
							</c:if>
							<c:if test="${bdto.image != 'none'}">
								<td>
									<a href="library_bookView.do?book_id=${bdto.book_id}&genre=${bdto.genre}"><img src="resources/book_img/${bdto.image}" class="book-img-thumbnail"></a>
								</td>
							</c:if>
							<td>
								<a href="library_bookView.do?book_id=${bdto.book_id}&genre=${bdto.genre}">${bdto.book_title}</a><br>
