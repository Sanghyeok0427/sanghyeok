	...
	<div class="card info-card sales-card">
		<div align="right" class="filter" style="position: absolute; right: 15px; top: 10px;">
			...
			<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style>
				...
				<li>
					<a class="dropdown-item" href="admin_update_reply_mb.do?rno=${replyList.rno}&major_board_code=${getBoard.major_board_code }">수정</a>
				</li>
				<li>
					<a class="dropdown-item" href="admin_delete_reply_mb.do?rno=${replyList.rno}&major_board_code=${getBoard.major_board_code }">삭제</a>
				</li>
			</ul>
			</div>
			<div class="card-body">
