...
<head>
	...
	<link rel="stylesheet" href="resources/admin_css/dist/css/adminlte.css">
	<style>
body:not(.layout-fixed) .main-sidebar2 {
  height: 1000px;
  width : 250px;
  min-height: 100%;
  position: absolute;
...
<div class="wrapper">	
	...
	<aside class="main-sidebar2 sidebar-dark-primary elevation-4">
		<!-- Brand Logo -->
	...
	<div class="content-wrapper px-4 py-2" style="min-height: 900.344px;margin-top: 1px;">